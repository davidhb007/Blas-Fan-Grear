(function (factory) {
            ...
            },
            {
                ...
                value: function _openModal(modal) {
                    ...
                    fastdom.mutate(function () {
                        ...
                        if (
                            !_this.activeModal.classList.contains(
                                "Modal--fullScreen"
                            )
                        ) {
                            _this.pageOverlayElement.classList.add(
                                "is-visible"
                            );
                ...
                value: function _closeModal() {
                    ...
                    fastdom.mutate(function () {
                        ...
                        if (
                            ...
                            _this2.pageOverlayElement.classList.remove(
                                "is-visible"
                            );
    ...
    var Popover = /*#__PURE__*/ (function () {
        function Popover(element, options) {
            ...
            this.preferredAlignment =
                options["preferredAlignment"] || undefined;
        ...
        _createClass(ProductImageZoom, [
            ...
            },
            {
                ...
                value: function _initPhotoSwipe() {
                    var images = [];
                    this.slideshow.flickityInstance.cells.forEach(function (
                        item
                    ) {
                        if (
            ...
            },
            {
                ...
                value: function _initPhotoSwipeFromImageClick(event, target) {
                    ...
                    this._createPhotoSwipeInstance(
                        this._createPhotoSwipeItemsFromImages(images),
                        parseInt(
                            target.getAttribute("data-image-media-position")
                        )
                    );
                },
                /**
                ...
                value: function _createPhotoSwipeItemsFromImages(images) {
                    return images.map(function (image) {
                        var maxWidth = parseInt(
                                image.getAttribute("data-max-width")
                            ),
                            maxHeight = parseInt(
                                image.getAttribute("data-max-height")
                            ),
                        ...
                        var requestedWidth = Math.floor(
                            maxWidth / reduceFactor
                        );
                        var requestedHeight = Math.floor(
                            maxHeight / reduceFactor
                        );
                        return {
                        ...
                        items,
                        {
                            ...
                            getDoubleTapZoom: function getDoubleTapZoom(
                                ...
                                if (isMouseClick) {
                                    ...
                                    return item.initialZoomLevel < 0.7
                                        ? 1
                                        : 1.33;
                                }
                            },
            ...
            },
            {
                ...
                value: function _onDoubleTap(point) {
                    ...
                    if (
                        this.photoSwipeInstance.getZoomLevel() !==
                        initialZoomLevel
                    ) {
            ...
            },
            {
                ...
                value: function _onReviewsLoad() {
                    ...
                    var sprSummaryActions = this.element.querySelector(
                        ...
                        previousSprPaginationNext =
                            sprSummaryActions.querySelector(
                                ".spr-pagination-next"
                            ),
        ...
        _createClass(Form, null, [
            {
                ...
                value: function serialize(form) {
                    function stringKey(key, value) {
                        ...
                        var newValue = {};
                        newValue[
                            key.substring(beginBracket + 1, key.length - 1)
                        ] = value;
        ...
        _createClass(VariantSelector, [
            ...
            },
            {
                ...
                value: function _onVariantChanged(event) {
                    ...
                    var selectedVariant = event.detail.variant,
                        ...
                        found = false;
                    Dom.nodeListToArray(imageWrapperElements).forEach(function (
                        image
                    ) {
                        var colorPosition =
                                parseInt(
                    ...
                    Dom.nodeListToArray(
                        ...
                        var colorPosition =
                            parseInt(
                                priceElement.getAttribute("data-color-position")
                            ) - 1;

                        _this.parentProductVariants.productData[
                            "variants"
                        ].forEach(function (variant) {
                            var matchOptionsExcludedColor = true;
                            variant["options"].forEach(function (
                                option,
                                index
                            ) {
                                if (index !== colorPosition) {
            ...
            },
            {
                ...
                value: function _onVariantSelect() {
                    var selectedCell =
                        this.variantCarousel.flickityInstance.selectedCell
                            .element;
                    this.onValueChangedCallback(
    ...
    var ProductVariants = /*#__PURE__*/ (function () {
        ...
        _createClass(ProductVariants, [
            ...
            },
            {
                ...
                value: function _updateProductPrices(
                    newVariant,
                    previousVariant
                ) {
            ...
            },
            {
                ...
                value: function _updateUnitPrice(newVariant) {
                    ...
                    unitPriceReferenceValue.style.display =
                        newVariant["unit_price_measurement"][
                            "reference_value"
                        ] === 1
                            ? "none"
                            : "inline";
            ...
            },
            {
                ...
                value: function _onOptionChanged(newValue, target, activator) {
                    ...
                    if (activator) {
                        this[
                            "option" +
                                target.getAttribute("data-option-position")
                        ] = newValue;
    ...
    var ScrollSpy = /*#__PURE__*/ (function () {
        ...
        _createClass(ScrollSpy, [
            ...
            },
            {
                ...
                value: function _updateIndicesInViewPort(
                    change,
                    oldTargetIndex
                ) {
                    ...
                    if (change.intersectionRatio === 0) {
                        var indexInViewPort =
                            this.indicesInViewPort.indexOf(index);
            ...
            },
            {
                ...
                value: function _initSelectors() {
                    ...
                    if (defaultCountry) {
                        for (
                            var i = 0;
                            i !== this.countrySelect.options.length;
                            ++i
                        ) {
                            if (
                                this.countrySelect.options[i].text ===
                                defaultCountry
                            ) {
                    ...
                    if (defaultProvince) {
                        for (
                            ...
                            if (
                                this.provinceSelect.options[_i].text ===
                                defaultProvince
                            ) {
            ...
            },
            {
                ...
                value: function _onCountryChanged() {
                    ...
                    provinces.forEach(function (data) {
                        _this.provinceSelect.options.add(
                ...
                value: function _reveal(results) {
                    ...
                    results.forEach(function (result) {
                        if (
                            ...
                            _this2.intersectionObserver.unobserve(
                                result.target
                            );
                        }
                    });
                    ...
                    fastdom.mutate(function () {
                        ...
                        if (_this2.articleNavElement) {
                            if (
                                ...
                                _this2.toolbarElement.classList.add(
                                    "is-visible"
                                );
                            } else {
                                _this2.toolbarElement.classList.remove(
                                    "is-visible"
                                );
                            }
                        } else {
                ...
                value: function _reveal(results) {
                    ...
                    results.forEach(function (result) {
                        if (
                            ...
                            _this3.intersectionObserver.unobserve(
                                result.target
                            );
                        }
                    });
                ...
                value: function _checkPosition() {
                    ...
                    fastdom.measure(function () {
                        var bounds = _this.element.getBoundingClientRect(),
                            ...
                            minTop =
                                _this.element.clientHeight - window.innerHeight;
                    ...
                    fastdom.mutate(function () {
                        _this.element.style.top = "".concat(
                            _this.currentTop,
                            "px"
                        );
                    });
    ...
    var CollectionSection = /*#__PURE__*/ (function () {
        function CollectionSection(element) {
            ...
            new ProductItemColorSwatch(
                this.element.querySelector(".ProductList")
            ); // Setup animation
        ...
        _createClass(CollectionSection, [
            ...
            },
            {
                ...
                value: function _changeLayoutMode(event, target) {
                    ...
                    var productList =
                        this.collectionInnerElement.querySelector(
                            ".ProductList"
                        );
                    ...
                    if (productList) {
                        ...
                        Dom.nodeListToArray(
                            ...
                            if (layoutType === "mobile") {
                                ...
                                ); // IE11 and lower does not support classList.replace

                                item.classList.add(
                                    "1/".concat(newCount, "--phone")
                                );
                            } else {
                                var previousTabletCount =
                                        previousCount === 2 ? 2 : 3,
                                    newTabletCount = newCount === 2 ? 2 : 3;

                                if (
                                    _this3.settings["filterPosition"] ===
                                    "drawer"
                                ) {
                                    item.classList.remove(
                                        "1/".concat(
                            ...
                            if (window.theme.showElementStaggering) {
                                item.firstElementChild.style.visibility =
                                    "hidden"; // Make it as hidden so we can re-trigger the animation
                            }
            ...
            },
            {
                ...
                value: function _onFilterChanged(event) {
                    ...
                    var searchParamsAsString = new URLSearchParams(
                        formData
                    ).toString();
                    ...
                    try {
                        ...
                        fetch(currentUrl.toString(), {
                            ...
                            response.text().then(function (content) {
                                ...
                                if (toolbarFilter) {
                                    var newToolbarFilter =
                                        _this4.element.querySelector(
                                            ".CollectionToolbar__Item--filter"
                                        );

                                    newToolbarFilter.innerHTML =
                                ...
                                if (collectionFiltersDrawer) {
                                    var newDrawerContent =
                                        tempElement.querySelector(
                                            "#collection-filters-drawer-form"
                                        );
                                    Array.from(
                                        collectionFiltersDrawer.querySelectorAll(
                                            ".Collapsible"
                                        )
                                    ).forEach(function (collapsible) {
                                        var newCollapsible =
                                            newDrawerContent.querySelector(
                                                '[data-filter-index="'.concat(
                                                    collapsible.getAttribute(
                                                        "data-filter-index"
                                                    ),
                                                    '"]'
                                                )
                                        ...
                                        if (
                                            ...
                                            newCollapsible.style.overflow =
                                                "visible";
                                            newCollapsible.firstElementChild.setAttribute(
                                                "aria-expanded",
                                                "true"
                                            );
                                            newCollapsible.lastElementChild.style.height =
                                                "auto";
                                ...
                                if (collectionFiltersSidebar) {
                                    var newSidebarContent =
                                        tempElement.querySelector(
                                            "#collection-filters-sidebar-form"
                                        );
                                    Array.from(
                                        collectionFiltersSidebar.querySelectorAll(
                                            ".Collapsible"
                                        )
                                    ).forEach(function (collapsible) {
                                        var newCollapsible =
                                            newSidebarContent.querySelector(
                                                '[data-filter-index="'.concat(
                                                    collapsible.getAttribute(
                                                        "data-filter-index"
                                                    ),
        ...
        _createClass(FaqSection, [
            ...
            },
            {
                ...
                value: function _switchToCategory(event, target) {
                    target.classList.add("is-active");
                    Dom.getSiblings(target, ".is-active").forEach(function (
                        item
                    ) {
            ...
            },
            {
                ...
                value: function _openItem(item) {
                    var answerWrapper = item.querySelector(
                        ".Faq__AnswerWrapper"
                    );
                    ...
                    Dom.getSiblings(item, '[aria-expanded="true"]').forEach(
                        function (siblingItem) {
                            var siblingAnswerWrapper =
                                siblingItem.querySelector(
                                    ".Faq__AnswerWrapper"
                                );
                            siblingItem.setAttribute("aria-expanded", "false");
                            siblingAnswerWrapper.setAttribute(
                                "aria-hidden",
                                "true"
                            );
        ...
        _createClass(FeaturedCollectionsSection, [
            ...
            },
            {
                ...
                value: function onBlockSelect(event) {
                    ...
                    this.element
                        .querySelector(
                            '[aria-controls="'.concat(event.target.id, '"]')
                        )
                        .click();
                },
            },
                ...
                value: function _reveal(results) {
                    ...
                    results.forEach(function (result) {
                        if (
                            ...
                            _this4.intersectionObserver.unobserve(
                                result.target
                            );
                        }
                    });
                        ...
                        if (_this2.options["videoType"] === "youtube") {
                            if (window.YT) {
                                _this2.player = new YT.Player(elementToInsert, {
                                    ...
                                    events: {
                                        onReady:
                                            _this2._onYouTubeReady.bind(_this2),
                                        onStateChange:
                                            _this2._onYouTubeStateChange.bind(
                                                _this2
                                            ),
                                    },
                                });
        ...
        _createClass(HeaderSection, [
            {
                ...
                value: function onUnload() {
                    ...
                    this.localizationPopovers.forEach(function (
                        localizationPopover
                    ) {
                ...
                value: function _focusNavigation() {
                    ...
                    fastdom.mutate(function () {
                        if (
                            ...
                            _this3.element.classList.remove(
                                "Header--transparent"
                            );
                        }
                    });
            ...
            },
            {
                ...
                value: function _verifyNavigationOverlap() {
                    ...
                    var isOverlapping = false,
                        mainTopMenu =
                            this.element.querySelector(".Header__MainNav");
                    fastdom.measure(function () {
                    ...
                    fastdom.mutate(function () {
                        if (isOverlapping) {
                            _this5.element.classList.remove(
                                "Header--".concat(
                                    _this5.options["navigationStyle"]
                                )
                            );
                ...
                value: function _checkTransparentHeader() {
                    ...
                    fastdom.mutate(function () {
                        if (_this6.lastScrollPosition <= scrollThreshold) {
                            ...
                            _this6.element.classList.remove(
                                "Header--transparent"
                            );
                        }
                    });
            ...
            },
            {
                ...
                value: function _setupSlideshowMobileNav() {
                    ...
                    if (this.slideshowMobileNav) {
                        var slideshowMobileNavDelegate =
                            new domDelegate.Delegate(this.slideshowMobileNav); // Handle the dot
                ...
                value: function _updateSlideshowImage(event) {
                    ...
                    if (
                        ...
                        for (
                            var i = 0;
                            i !==
                            this.productSlideshow.flickityInstance.cells.length;
                            ++i
                        ) {
                            var cellElement =
                ...
                value: function _onScrollTargetChanged(event) {
                    ...
                    if (this.options["stackProductImages"]) {
                        ...
                        this.slideshowNavDotsItems[
                            parseInt(
                                event.detail.newTarget.getAttribute(
                                    "data-media-position"
                                )
                            ) - 1
                        ...
                        if (this.options["showThumbnails"]) {
                            this.slideshowNavThumbnailsItems.forEach(function (
                                item
                            ) {
                                return item.classList.remove("is-selected");
                            });
            ...
            },
            {
                ...
                value: function _toggleSocialShare(event, target) {
                    ...
                    target.nextElementSibling.setAttribute(
                        "aria-hidden",
                        target.nextElementSibling.getAttribute(
                            "aria-hidden"
                        ) === "true"
                            ? "false"
                            : "true"
                ...
                value: function _onImageChanged(event, cell) {
                    ...
                    if (
                        ...
                        this.slideshowNavThumbnailsItems.forEach(function (
                            ...
                            if (
                                thumbnail.getAttribute("data-media-id") ===
                                mediaId
                            ) {
                    ...
                    if (this.slideshowMobileNav) {
                        var selectedIndex =
                            parseInt(cell.getAttribute("data-media-position")) -
                            1; // The -1 is to make it 0 indexed
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                ...
                                offsetTop =
                                    this.slideshowNavDots.firstElementChild
                                        .offsetTop;
                            }
                        ...
                        var productInfoStyles = window.getComputedStyle(
                            ...
                            productGalleryHeight = this.productGalleryElement
                                ? parseInt(
                                      this.productGalleryElement.scrollHeight
                                  )
            ...
            },
            {
                ...
                value: function _getSearchQueryString() {
                    ...
                    if (items.includes(this.options["productId"])) {
                        items.splice(
                            items.indexOf(this.options["productId"]),
                            1
                        );
                    }
        ...
        _createClass(SectionContainer, [
            ...
            },
            {
                ...
                value: function _onSectionLoad(event) {
                    var container =
                        event.target.querySelector("[data-section-id]");
        ...
        _createClass(ShopTheLookSection, [
            ...
            },
            {
                ...
                value: function _onDotClicked(event, target) {
                    ...
                    this.innerCarousels[lookIndex].forEach(function (
                        innerCarousel
                    ) {
                        innerCarousel.selectCell(
                            parseInt(
                                target.getAttribute("data-product-index")
                            ) - 1,
                            false,
                    ...
                    fastdom.measure(function () {
                        ...
                        var scale =
                                ...
                                (selectedCell.offsetWidth -
                                    parseInt(
                                        window.getComputedStyle(selectedCell)
                                            .paddingLeft
                                    ) *
                                        2),
                            ...
                            hiddenImageHeight = Math.round(
                                Math.max(
                                    heightAfterScale -
                                        (window.innerHeight -
                                            openPopover.element.offsetHeight),
                                    0
                                )
                            ),
                            // Part of image that is below popover
                            visibleImageHeight =
                                heightAfterScale - hiddenImageHeight,
                            ...
                            maxTranslateY = Math.round(
                                minTranslateY - hiddenImageHeight
                            ); // The maximum translate Y transform allowed so that image is visible

                        _this4._calculateTransformForDotListener = function (
                            event
                        ) {
        ...
        _createClass(SlideshowSection, [
            ...
            },
            {
                ...
                value: function _lazyLoadNextImage() {
                    var currentIndex =
                            this.slideshow.flickityInstance.selectedIndex,
                    ...
                    if (
                        ...
                        var nextCellElement =
                                this.slideshow.flickityInstance.cells[
                                    currentIndex + 1
                                ].element,
                        ...
                        if (
                            ...
                            lazySizes.loader.unveil(
                                imageToReveal.firstElementChild
                            );
                        }
                    }
                },
                    ...
                    fastdom.measure(function () {
                        ...
                        if (isContentLarger) {
                            var beginBound = target.offsetLeft,
                                ...
                                closerToLeft =
                                    beginBound <= visibleWidth - endBound;
                            var itemToUse = null;
                            ...
                            var itemBeginBound =
                                    itemToUse.offsetLeft -
                                    navWrapper.scrollLeft,
                                itemEndBound =
                                    itemBeginBound + itemToUse.offsetWidth;
                        ...
                        function (event) {
                            event.target.value = Math.max(
                                Math.min(
                                    ...
                                    parseInt(
                                        _this.textInputHigherBound.value ||
                                            event.target.max
                                    ) - 1
                                ),
                                event.target.min
                        ...
                        function (event) {
                            event.target.value = Math.min(
                                Math.max(
                                    parseInt(event.target.value),
                                    parseInt(
                                        _this.textInputLowerBound.value ||
                                            event.target.min
                                    ) + 1
                                ),
                                event.target.max
    ...
    (function () {
        ...
        (function () {
            ...
            document.body.addEventListener(
                ...
                function (e) {
                    ...
                    if (
                        Math.abs(moveVector.x) > Flickity.defaults.dragThreshold
                    )
                        e.preventDefault();
                },
                {
            ...
            Dom.nodeListToArray(
                ...
                if (
                    ...
                    iframe.outerHTML =
                        ...
                        iframe.outerHTML +
                        "</div>"; // Re-set the src attribute on each iframe after page load for Chrome's "incorrect iFrame content on 'back'" bug.
            ...
            documentDelegate.on(
                ...
                function (event, target) {
                    ...
                    var element = document.querySelector(selector),
                        offset = parseInt(
                            target.getAttribute("data-offset") || 0
                        );
        ...
        (function () {
            var windowWidth = window.innerWidth,
                headerSection = document.getElementById(
                    "shopify-section-header"
                );
            window.addEventListener("resize", function () {
                var newWidth = -1;
